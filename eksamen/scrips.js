...
function sidenVises() {
  console.log("Hej");
  h1.addEventListener("click", lys);
}

function lys() {
  console.log("lys");

  h1.firstElementChild.classList.add("glow");
  h1.removeEventListener("sluk", sluk1);
  h1.addEventListener("click", sluk1);
}

function sluk1() {
  console.log("sluk1");
  this.removeEventListener("glow", lys);
  this.firstElementChild.classList.add("sluk");

  this.addEventListener("click", lysreset);
}

function lysreset() {
  console.log("lysreset");
  this.firstElementChild.removeEventListener("sluk", sluk1);
